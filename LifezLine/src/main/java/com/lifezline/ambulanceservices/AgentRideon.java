...
import com.bafl.ambulance.constants.Agent_Reached_Source_Status;
...
public class AgentRideon {

	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(AgentRideon.class.getName());

	@RequestMapping(method = RequestMethod.POST, value = "/AgentRideon")
	@ResponseBody
		...
		try {
			...
			if (!query.list().isEmpty()) {
				...
				while (it.hasNext()) {
					...
					detail.setAgentRideStatus("started");
